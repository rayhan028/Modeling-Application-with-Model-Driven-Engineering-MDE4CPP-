...
#ifndef CLINICMODEL_PLUGIN_HPP
#define CLINICMODEL_PLUGIN_HPP

#include "pluginFramework/UMLModelPlugin.hpp"

namespace ClinicModel
{
	class ClinicModelPlugin : virtual public UMLModelPlugin
	{
		public:
		...
		protected:
			ClinicModelPlugin(){};
			virtual ~ClinicModelPlugin(){};
	};
}
#endif /* end of include guard: CLINICMODEL_PLUGIN_HPP */
