...
exe_paths = [
    r"C:\MDE4CPP\MDE4CPP\application\bin\App_ClinicModel.exe"
]

csv_filename = "resource_usage_log.csv"

# Define Num_of_Instance manually for each run
num_of_instance_list = [1000, 2000, 3000, 5000, 6000, 10000, 20000, 40000, 50000]  
